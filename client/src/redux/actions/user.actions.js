...
// const getSingleUserByUserId = (userId) => async (dispatch) => {
//   dispatch({ type: types.GET_SINGLE_USER_BY_USERID_REQUEST, payload: null });
//   try {
//     const res = await api.get(`/users/${userId}`);
//     dispatch({
//       type: types.GET_SINGLE_USER_BY_USERID_SUCCESS,
//       payload: res.data,
//     });
//   } catch (error) {
//     dispatch({
//       type: types.GET_SINGLE_USER_BY_USERID_FAILURE,
//       payload: error,
//     });
//   }
// };
